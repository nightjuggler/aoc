...
def to_str(a):
	return chr(a) if 32 <= a < 127 or a == 10 else str(a)

def run_str(intcode, springscript):
	return ''.join(map(to_str, run(intcode, map(ord, springscript))))
...
RUN
'''
	print(run_str(program, part1))
	print(run_str(program, part2))
main()
